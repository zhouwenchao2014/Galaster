...
#define FGAPIENTRY
#define FREEGLUT_EXIT_IF_NOT_INITIALISED(f)
#define fgError(...)   { fprintf(stderr, __VA_ARGS__); fprintf(stderr, "\n"); }
#define fgWarning(...) { fprintf(stderr, __VA_ARGS__); fprintf(stderr, "\n"); }
...
static void fghDrawGeometrySolid(GLfloat *vertices, GLfloat *normals, GLfloat *textcs, GLsizei numVertices,
